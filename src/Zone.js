...
//mineIMG.src = '../img/mine.svg'; //Works with preview mode in Brackets
var flagIMG = new Image();
//flagIMG.src = '../img/flag.svg'; //Works with preview mode in Brackets
...
/* Images are hosted on github, but since the URL takes too much place, I've put it at the end. The browser can't access file from the directory so it won't be able to display the images if they're not hosted on the web */
