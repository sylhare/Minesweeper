...
/* Images are hosted on github, but since the URL takes too much place, I've put it at the end. Sometime, the browser can't access file from the directory so it won't be able to display the images, here are the back up links. */
